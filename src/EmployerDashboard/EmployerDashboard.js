...
class EmployerDashboard extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        if (prevProps.singleRequestData !== this.props.singleRequestData) {

            this.setState({
                singleRequestData: this.props.singleRequestData,
                responseMessage: (
                    <span>
                        Job Created Successfully!
                    </span>
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    ...
                                    <div class="row g-5">
                                                                ...
                                                                <ul className="dashboard-mainmenu rbt-default-sidebar-list">
                                                                    <li>
                                                                        <a className={this.state.showUserDashboard ? 'active' : ''} onClick={(e) => { e.preventDefault(); this.setActiveComponent('dashboard'); }} href="#">
                                                                            <i className="feather-home"></i><span>Employer Dashboard</span>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                        ...
                                        {this.state.showEnrollCourse && <EnrolledJobs />}
                                        {this.state.showMyCourses && <MyJobs />}
