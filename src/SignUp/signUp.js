    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                <Modal show={this.state.showModal} onHide={this.close} size="lg" centered>
                <Modal.Header>
      ...
      style={{
        ...
        fontWeight: 'bold',
        marginLeft: 'auto',
        color: '#000', // change to white if modal header is dark
      }}
    >
      ×
    </span>
                </Modal.Header>
                <Modal.Body style={{ maxHeight: '400px', overflowY: 'auto', textAlign: 'center' }}>
                    <TermsCondition reqType={this.props?.singleRequestData?.SignUpType} />
                </Modal.Body>
                <Modal.Footer>
                    <Button
                    style={{ fontSize: '14px' }}
