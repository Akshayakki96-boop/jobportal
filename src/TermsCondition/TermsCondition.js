...
class TermsCondition extends Component {
    ...
    render() {
        return (
            ...
            <h1 style={{ color: '#333' }}>Terms and Conditions for Candidates/Students on Zobskill.com</h1>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>1. Definitions</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>2. Registration and Use of the Platform</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>3. Course Fees and Payment</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>4. Refund Policy</h2>
                <p>Zobskill.com offers a <strong>performance-based refund policy</strong> applicable under the following conditions:</p>

                <h3 style={{ marginTop: '20px' }}>4.1. Refund for Exam Qualification</h3>
                <ul>
                ...
                <h3 style={{ marginTop: '20px' }}>4.2. Refund for Job Placement</h3>
                <ul>
                ...
                <h3 style={{ marginTop: '20px' }}>4.3. Exclusions</h3>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>5. Candidate Responsibilities</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>6. Prohibited Activities</h2>

                <h3 style={{ marginTop: '20px' }}>6.1. Appropriate Sharing of Contact Information</h3>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>7. Data Protection and Privacy</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>8. Limitation of Liability</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>9. Termination</h2>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>10. Amendments to Terms</h2>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>11. Contact Information</h2>
        ...
        <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: '1.6', margin: '20px',textAlign: 'justify' }}>
            <h1 style={{ color: '#333' }}>Employer Terms and Conditions for Zobskill.com</h1>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>2. Registration and Account</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>3. Job Posting Guidelines</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>4. Employer Obligations</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>5. Fees and Payments</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>6. Prohibited Conduct</h2>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>7. Content Ownership and Rights</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>8. Termination and Suspension</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>9. Limitation of Liability</h2>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>10. Privacy Policy</h2>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>11. Dispute Resolution</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>12. Amendments to Terms</h2>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>13. Contact Information</h2>
        ...
        <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: '1.6', margin: '20px',textAlign: 'justify' }}>
            <h1 style={{ color: '#333' }}>Trainer Terms and Conditions for Zobskill.com</h1>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>2. Eligibility</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>3. Trainer Responsibilities</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>4. Course Listing and Approval</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>5. Revenue Sharing and Payments</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>6. Intellectual Property</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>7. Termination</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>9. Confidentiality</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>10. Dispute Resolution</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>11. Restrictions on Sharing Personal Contact Information</h2>
                <ul>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>12. Amendments</h2>
            ...
            <div style={{ marginBottom: '30px' }}>
                <h2 style={{ borderBottom: '2px solid #333', paddingBottom: '5px' }}>13. Contact</h2>
